...
int enterevent(xcb_generic_event_t *);
int focusevent(xcb_generic_event_t *);

int main (int argc, char *argv[]) {
    int arg;

    while ((arg = getopt(argc, argv, "lm:")) != -1) {
	    switch(arg) {
	    	case 'l':
	    		list_events();
	    		exit(0);
...
void register_events(xcb_window_t w, uint32_t m) {
	uint32_t val[] = { m };
...
int enterevent(xcb_generic_event_t *e) {
...
int focusevent(xcb_generic_event_t *e) {
...
xcb_window_t get_window_id(xcb_generic_event_t *e) {
	xcb_window_t wid;
